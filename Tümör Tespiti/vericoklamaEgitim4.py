...
class YSAEgitim1():
    def __init__(self):
        ...
        self.loadedFeatureTumor2 = np.load(f'TumorPatches_Patient1_{self.patch_boyut}.npy')
        self.loadedFeatureTumor3 = np.load(f'TumorPatches_Patient2_{self.patch_boyut}.npy')
        self.loadedFeatureTumor4 = np.load(f'TumorPatches_Patient3_{self.patch_boyut}.npy')
        self.loadedFeatureTumor5 = np.load(f'TumorPatches_Patient5_{self.patch_boyut}.npy')

        self.loadedFeatureArka2 = np.load(f'BackgroundPatches_Patient1_{self.patch_boyut}.npy')
        self.loadedFeatureArka3 = np.load(f'BackgroundPatches_Patient2_{self.patch_boyut}.npy')
        self.loadedFeatureArka4 = np.load(f'BackgroundPatches_Patient3_{self.patch_boyut}.npy')
    ...
    def createYSA(self):
        ...
        # Modeli kaydetme
        self.test = self.YSA.save('YSA4-v2')
