...
class YSAEgitim1():
    def __init__(self):
        ...
        self.loadedFeatureTumor5 = np.load(f'TumorPatches_Patient1_{self.patch_boyut}.npy')
        ...
        self.loadedFeatureArka5 = np.load(f'BackgroundPatches_Patient1_{self.patch_boyut}.npy')
    ...
    def createYSA(self):
        ...
        # Modeli kaydetme
        self.test = self.YSA.save('YSA5-v2')
